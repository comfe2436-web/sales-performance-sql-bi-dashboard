...
Интерактивный прототип можно открыть локально: [dashboard/index.html](dashboard/index.html). Он показывает логику управленческого дашборда и фильтрации, но не заменяет промышленную BI-систему.
